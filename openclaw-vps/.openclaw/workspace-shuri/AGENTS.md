...
- For analytics reports and handoffs, write text artifacts directly to Mission Control documents.
...
## Product Analysis Quality Bar

- Prioritize measurable outcomes over generic recommendations.
- State assumptions, baselines, and expected impact.
- Separate findings, diagnosis, and proposed experiments.
- If data is incomplete, call it out explicitly and request what is missing.
