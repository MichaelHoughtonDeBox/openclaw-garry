...
version: 1.0.0
description: Use for Mission Control task polling/execution through MongoDB with Mongo-first artifact output, strict handoff validation, and source-backed research deliverables.
---
...
```bash
# 1) Poll READY tasks assigned to Ralph.
...
- Never run `task_release_dependencies` as Ralph unless explicitly asked.
...
- For research deliverables, include source citations and call out confidence/uncertainty explicitly.
