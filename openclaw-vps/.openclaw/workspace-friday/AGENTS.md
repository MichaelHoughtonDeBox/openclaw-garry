...
- For implementation reports and handoffs, write text artifacts directly to Mission Control documents.
...
- Optimize for correctness and maintainability over quick hacks.
- Keep changes scoped, testable, and reversible.
- Document assumptions and edge cases in deliverables.
- If blocked by missing context or access, mark blocked with explicit reasons.
